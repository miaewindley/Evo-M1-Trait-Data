...
# Save the data frame to a to a CSV file
write.csv(result_df, file = "dossantos_etal_2020_Table1.csv", row.names = FALSE)

# Save the data frame to a to a TSV file for online database
write.csv(result_df, file = "10.1523%2FJNEUROSCI.2339-19.2020%0A_table1.tsv", row.names = FALSE)
