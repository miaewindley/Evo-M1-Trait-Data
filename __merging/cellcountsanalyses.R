...
## 1.3 Calculate variables to match them across datasets before filtering
...
# 1.3.2 Different "whole brain" definitions were used by different teams. Kverkova Team included olfactory bulb, whereas Herculano-Houzel Team did not (see definitions).
...
# 1.3.3 Add a column converting mass from kg to g
...
# 1.3.4 Calculate Mass.g data which was not reported in Herculano-Houzel et al. 2020 TABLE 2 but can be calculated within it: CerebralCortex_Mass.g, Cerebellum_Mass.g, RoB_Mass.g
