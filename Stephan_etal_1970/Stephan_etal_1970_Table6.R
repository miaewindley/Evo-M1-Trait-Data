...
#
# Table 6. Volumes of the telencephalon components (mm3) in simians
...
#
# Input : Stephan_etal_1970_Table6_snapshot.csv
# Output: Stephan_etal_1970_Table6.csv  +  ISBN-encoded TSV in __Public/comparative-data/
...
snap <- read_csv(file.path(folder, "Stephan_etal_1970_Table6_snapshot.csv"), show_col_types = FALSE)
...
clean <- snap %>%
  transmute(species, group,
            ...
            source = "Stephan_etal_1970_Table6")
...
item_encoded <- "ISBN%3A0390672505_TABLE6"
if (!is.na(base)) {
