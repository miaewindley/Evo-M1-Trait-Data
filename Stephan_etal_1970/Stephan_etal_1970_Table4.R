...
#
# Table 4. Volumes of the telencephalon components (mm3) in insectivores
...
#
# Input : Stephan_etal_1970_Table4_snapshot.csv
# Output: Stephan_etal_1970_Table4.csv  +  ISBN-encoded TSV in __Public/comparative-data/
...
snap <- read_csv(file.path(folder, "Stephan_etal_1970_Table4_snapshot.csv"), show_col_types = FALSE)
...
clean <- snap %>%
  transmute(species, group,
            ...
            source = "Stephan_etal_1970_Table4")
...
item_encoded <- "ISBN%3A0390672505_TABLE4"
if (!is.na(base)) {
