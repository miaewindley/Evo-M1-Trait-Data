# Smaers_etal_2017_TableS1_part1_volumes.R
#
...
# surface-area block; see Smaers_etal_2017_TableS1_part2_surfacearea.R.)
#
...
# Input  : Smaers_etal_2017_TableS1_part1_volumes_snapshot.xlsx   sheet: volumes
# Outputs: Smaers_etal_2017_TableS1_part1_volumes.csv             one row per species (19)
#          <DOI>_TableS1_part1_volumes.tsv in __Public/comparative-data/  (named from __ReadMe.xlsx)
...
output_file    <- "Smaers_etal_2017_TableS1_part1_volumes.csv"
header_rows    <- 3L
