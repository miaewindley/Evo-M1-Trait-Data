# Smaers_etal_2017_TableS1_part1_volumes_compare_to_Smaers_csv.R
#
...
#
# Inputs : ../Smaers_etal_2017_TableS1_part1_volumes_snapshot.xlsx (sheet volumes) ; Smaers.csv
# Outputs: Smaers_etal_2017_TableS1_part1_volumes_comparison_report_from_R.csv
#          Smaers_etal_2017_TableS1_part1_volumes_comparison_mismatches_from_R.csv
...
snapshot_file     <- "../Smaers_etal_2017_TableS1_part1_volumes_snapshot.xlsx"
snapshot_sheet    <- "volumes"
comparison_file   <- "Smaers.csv"
output_detail     <- "Smaers_etal_2017_TableS1_part1_volumes_comparison_report_from_R.csv"
output_mismatches <- "Smaers_etal_2017_TableS1_part1_volumes_comparison_mismatches_from_R.csv"
header_rows       <- 3L
