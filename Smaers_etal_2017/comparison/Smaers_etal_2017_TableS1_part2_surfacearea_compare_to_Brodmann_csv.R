# Smaers_etal_2017_TableS1_part2_surfacearea_compare_to_Brodmann_csv.R
#
...
#
# Inputs : ../Smaers_etal_2017_TableS1_part2_surfacearea_snapshot.xlsx (sheet surface_area) ; Brodmann_surface_1909.csv
# Outputs: Smaers_etal_2017_TableS1_part2_surfacearea_comparison_report_from_R.csv
#          Smaers_etal_2017_TableS1_part2_surfacearea_comparison_mismatches_from_R.csv
...
snapshot_file     <- "../Smaers_etal_2017_TableS1_part2_surfacearea_snapshot.xlsx"
snapshot_sheet    <- "surface_area"
comparison_file   <- "Brodmann_surface_1909.csv"
output_detail     <- "Smaers_etal_2017_TableS1_part2_surfacearea_comparison_report_from_R.csv"
output_mismatches <- "Smaers_etal_2017_TableS1_part2_surfacearea_comparison_mismatches_from_R.csv"
header_rows       <- 3L
