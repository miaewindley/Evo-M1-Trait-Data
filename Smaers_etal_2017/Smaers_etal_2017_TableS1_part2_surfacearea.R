# Smaers_etal_2017_TableS1_part2_surfacearea.R
#
...
# (Part 1 = the Smaers volume block; see Smaers_etal_2017_TableS1_part1_volumes.R.)
#
...
# Input  : Smaers_etal_2017_TableS1_part2_surfacearea_snapshot.xlsx   sheet: surface_area
# Outputs: Smaers_etal_2017_TableS1_part2_surfacearea.csv             one row per species (10)
...
output_file    <- "Smaers_etal_2017_TableS1_part2_surfacearea.csv"
header_rows    <- 3L
