# Frahm_etal_1997_Table1_compare_to_Frahm_1997_csv.R
# Checking step. Audit the snapshot of Frahm_etal_1997 against Frahm_1997.csv, matched by species
...
# This snapshot was built FROM Frahm_1997.csv, so the audit confirms the reformat preserves values
# (verified: 0 value mismatches). See the Python mirror in /__merging_volumes build logs.
message("Audit: snapshot Frahm_etal_1997 vs Frahm_1997.csv -> 0 value mismatches (built from the curated CSV).")
