...
item_name <- c(
 ...
 # "DosSantos_etal_2020_Table1",
  "DosSantos_etal_2020_unpublished", #wrong data
...
# These are exempt, because NCBI Taxon ID doesn't apply at species level: Dasyprocta prymnolopha, Cynomys sp., Crocidura jacksoni
