# Stephan_etal_1981_TablesI-VI.R
#
...
# ../_keys/Stephan/.
#
# Input  : Stephan_etal_1981_TablesI-VI_snapshot.xlsx        sheet: Table1
# Outputs: Stephan_etal_1981_TablesI-VI.csv                  one row per species (76)
...
output_file    <- "Stephan_etal_1981_TablesI-VI.csv"
