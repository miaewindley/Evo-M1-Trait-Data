# Stephan_etal_1981_TablesI-VI_compare_to_Stephan_1981_csv.R
#
...
# Run from comparison/.
#
# Inputs : ../Stephan_etal_1981_TablesI-VI_snapshot.xlsx (sheet Table1) ; Stephan_1981.csv
# Outputs: Stephan_etal_1981_TablesI-VI_comparison_report_from_R.csv
#          Stephan_etal_1981_TablesI-VI_comparison_mismatches_from_R.csv
...
snapshot_file   <- "../Stephan_etal_1981_TablesI-VI_snapshot.xlsx"
snapshot_sheet  <- "Table1"
comparison_file <- "Stephan_1981.csv"
out_detail      <- "Stephan_etal_1981_TablesI-VI_comparison_report_from_R.csv"
out_mismatch    <- "Stephan_etal_1981_TablesI-VI_comparison_mismatches_from_R.csv"
...
# --- CSV ---
# Stephan_1981.csv: latin1, so every byte is read (a stray 0xCA byte in "Scutisorex
# somereni" is not valid UTF-8 and otherwise breaks readr's condition-message formatting
# with "invalid multibyte string" when it tries to warn about the parse).
csv <- read_csv(comparison_file, locale = locale(encoding = "latin1"),
