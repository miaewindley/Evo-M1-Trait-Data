# DeCasien & Higham 2019 - Social System Data
...
- **Worksheet:** `Social System Data`
- **Rows written:** 72
- **Role:** Source social-system classifications, harmonised system category and explanatory notes.
...
- **Reformat:** `DeCasien_Higham_2019_SocialSystemData.R` reads only this worksheet, removes only wholly empty formatting rows/columns, preserves source fields and writes:
  - `DeCasien_Higham_2019_SocialSystemData.csv`
  - `__Public/comparative-data/10.1038%2Fs41559-019-0969-0_SocialSystemData.tsv` when no registry encoding is available.
