...
snap <- read_excel(source_file, sheet = "Activity Period Data", col_names = TRUE)
...
if (is.na(item_encoded) || !nzchar(item_encoded))
  item_encoded <- "10.1038%2Fs41559-019-0969-0_ActivityPeriodData"
...
cat("DeCasien & Higham 2019 - Activity Period Data:", nrow(df), "rows written\n")
