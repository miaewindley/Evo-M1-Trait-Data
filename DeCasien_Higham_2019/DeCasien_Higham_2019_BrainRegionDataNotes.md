# DeCasien & Higham 2019 - Brain Region Data Notes
...
- **Worksheet:** `Brain Region Data Notes`
- **Rows written:** 5
- **Role:** Decoding table for replacement-note codes A-F used in the brain-region sheet.
...
- **Reformat:** `DeCasien_Higham_2019_BrainRegionDataNotes.R` reads only this worksheet, removes only wholly empty formatting rows/columns, preserves source fields and writes:
  - `DeCasien_Higham_2019_BrainRegionDataNotes.csv`
  - `__Public/comparative-data/10.1038%2Fs41559-019-0969-0_BrainRegionDataNotes.tsv` when no registry encoding is available.
