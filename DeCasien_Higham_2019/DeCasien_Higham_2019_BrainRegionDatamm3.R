...
snap <- read_excel(source_file, sheet = "Brain Region Data (mm3)", col_names = TRUE)
...
if (is.na(item_encoded) || !nzchar(item_encoded))
  item_encoded <- "10.1038%2Fs41559-019-0969-0_BrainRegionDatamm3"
...
cat("DeCasien & Higham 2019 - Brain Region Data (mm3):", nrow(df), "rows written\n")
