# DeCasien & Higham 2019 - Diet Data
...
- **Worksheet:** `Diet Data`
- **Rows written:** 72
- **Role:** Species diet categories, source reference numbers, notes and the cited source inherited from reference 38.
...
- **Reformat:** `DeCasien_Higham_2019_DietData.R` reads only this worksheet, removes only wholly empty formatting rows/columns, preserves source fields and writes:
  - `DeCasien_Higham_2019_DietData.csv`
  - `__Public/comparative-data/10.1038%2Fs41559-019-0969-0_DietData.tsv` when no registry encoding is available.
