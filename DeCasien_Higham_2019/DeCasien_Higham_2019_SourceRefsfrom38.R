...
snap <- read_excel(source_file, sheet = "Source Refs (from 38)", col_names = TRUE)
...
if (is.na(item_encoded) || !nzchar(item_encoded))
  item_encoded <- "10.1038%2Fs41559-019-0969-0_SourceRefsfrom38"
...
cat("DeCasien & Higham 2019 - Source Refs (from 38):", nrow(df), "rows written\n")
