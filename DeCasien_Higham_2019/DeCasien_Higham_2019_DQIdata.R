...
snap <- read_excel(source_file, sheet = "DQI data", col_names = TRUE)
...
if (is.na(item_encoded) || !nzchar(item_encoded))
  item_encoded <- "10.1038%2Fs41559-019-0969-0_DQIdata"
...
cat("DeCasien & Higham 2019 - DQI data:", nrow(df), "rows written\n")
