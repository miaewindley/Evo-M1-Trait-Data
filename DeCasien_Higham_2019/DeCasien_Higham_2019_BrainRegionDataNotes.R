...
snap <- read_excel(source_file, sheet = "Brain Region Data Notes", col_names = TRUE)
...
df <- as.data.frame(snap, stringsAsFactors = FALSE)
# This reference/notes table has no Taxon field, so no species_sci column is added.
...
if (is.na(item_encoded) || !nzchar(item_encoded))
  item_encoded <- "10.1038%2Fs41559-019-0969-0_BrainRegionDataNotes"
...
cat("DeCasien & Higham 2019 - Brain Region Data Notes:", nrow(df), "rows written\n")
