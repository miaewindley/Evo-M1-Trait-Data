...
- match (same species + same structure, value within tol): **1024**
- match_taxonomy_variant (same structure + value, species NAME differs): **315** -> see II.B
- value_match_other_structure (value matched a different structure/label): **292**
- decasien_only (no value match in the merge for that genus): **521**
...
## II.B taxonomy
10 species appear under a DeCasien binomial that value-matches a DIFFERENT name in the merge
