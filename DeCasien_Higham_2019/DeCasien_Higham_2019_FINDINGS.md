...
- match (same species + same structure, value within tol): **1788**
- match_taxonomy_variant (same structure + value, species NAME differs): **215** -> see II.B
...
- decasien_only (no value match in the merge for that genus): **0**
