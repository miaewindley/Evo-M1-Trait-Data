...
snap <- read_excel(source_file, sheet = "Social System Data", col_names = TRUE)
...
if (is.na(item_encoded) || !nzchar(item_encoded))
  item_encoded <- "10.1038%2Fs41559-019-0969-0_SocialSystemData"
...
cat("DeCasien & Higham 2019 - Social System Data:", nrow(df), "rows written\n")
