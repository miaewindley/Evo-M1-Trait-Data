# DeCasien & Higham 2019 - Activity Period Data
...
- **Worksheet:** `Activity Period Data`
- **Rows written:** 72
- **Role:** Species activity-period categories, source reference numbers and notes.
...
- **Reformat:** `DeCasien_Higham_2019_ActivityPeriodData.R` reads only this worksheet, removes only wholly empty formatting rows/columns, preserves source fields and writes:
  - `DeCasien_Higham_2019_ActivityPeriodData.csv`
  - `__Public/comparative-data/10.1038%2Fs41559-019-0969-0_ActivityPeriodData.tsv` when no registry encoding is available.
