...
if (requireNamespace("rstudioapi", quietly = TRUE) && rstudioapi::isAvailable())
  setwd("/Users/crossmodal/Library/CloudStorage/OneDrive-AllenInstitute/Species/Evo-M1-Trait-Data/_setwd_backup/_setwd_backup/Matano_etal_1985_a")
...
final.dataframe <- dat %>%
  ...
  transmute(
    ...
    Species_Matano1985a = str_squish(species_disp),
