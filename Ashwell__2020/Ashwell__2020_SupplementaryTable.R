...
## 1. Source
# Downloaded Word file from journal website
# Copy-and-paste Word text into Excel
# Minor changes to Excel formatting (heading format; removed all-NA rows)

## 2. Table 2
#1. Read direct from xl
folder_path <- "./Ashwell__2020/"
tabledirectxl <-
  read_excel(paste0(folder_path, "Ashwell__2020_SupplementaryTable_snapshot.xlsx"))
