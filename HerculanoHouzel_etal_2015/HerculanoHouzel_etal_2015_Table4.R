...
columns_to_convert <- c("n", "Mass, g", "Mass, g SD", "N, n", "N, n SD", "O, n", "O, n SD", "N/mg", "N/mg SD", "O/mg", "O/mg SD", "O/N", "O/N SD")
...
columns_to_rename <- c("n", "Mass, g", "Mass, g SD", "N, n", "N, n SD", "O, n", "O, n SD", "N/mg", "N/mg SD", "O/mg", "O/mg SD", "O/N", "O/N SD", "Source")
...
write.csv(tabledirectxl, file = "HerculanoHouzel_etal_2015_Table4.csv", row.names = FALSE)

# Save the data frame to a TSV file for online database
write.csv(tabledirectxl, file = "~/Library/CloudStorage/OneDrive-AllenInstitute/Species/Evo M1 Trait Data/__Public/comparative-data/10.1159%2F000437413_Table4.tsv", row.names = FALSE)
