## Balzeau_etal_2012 Table 3 — QA / checking step
## Audit the frozen snapshot (../Balzeau_etal_2012_Table3_snapshot.csv) against
## the pre-existing curated table (comparison/balzeau.csv). Requires 0 value
## mismatches on n / Mean / V* across the 5 samples x 3 lobes (45 values).
...
curated_file    <- "balzeau.csv"
out_report      <- "Balzeau_etal_2012_Table3_comparison_report_from_R.csv"
out_mismatches  <- "Balzeau_etal_2012_Table3_comparison_mismatches_from_R.csv"
...
## snapshot: positional read of the three lobe rows (rows 4-6)
...
## curated: the file is effectively one mangled line; pull each lobe's 15 numbers
